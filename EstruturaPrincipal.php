<?php
  ...
  if($_SESSION['departamento'] === 'ADMINISTRATIVO' || $_SESSION['credencial'] >= 4){
    $acesso1 = '00SeletorAdministrativo.php';
    $acesso7 = '11CadastroFuncionario.php'; 
  }else{
    $acesso1 = ''; $acesso7 = '';
  }
  ...
  <body>
    ...
    <div class="sidebarBottom"><br>
      ...
      <p style="padding: 3px; color: rgba(0,0,0,0.7)">
        ...
        <a href="13EditaDadosPessoais.php">
        ...
        <P style="padding: 5px; color: greenyellow; float: right"><?php echo ' Você tem ' .$numMsg. ' mensagens não lidas' ?></P>
      </div>
    </div>
