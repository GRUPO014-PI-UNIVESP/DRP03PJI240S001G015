...
$listar = $connDB->prepare("SELECT * FROM quadro_funcionarios ORDER BY NOME_FUNCIONARIO ASC");
$listar->execute();
?>
<!-- Área Principal -->
  <div class="main">
    <div class="container">
      ...
      <button class="btn btn-sm btn-primary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Reordenar por</button>
        <ul class="dropdown-menu">
          <li><a class="dropdown-item" href="07QuadroFuncionarios.php">Cargo</a></li>
      ...
      <div class="overflow-auto">
        <table class="table table-dark table-hover">
          <p style="font-size: 12px; color: bisque">Ordenado por Nome</p>
          ...
          <tbody style="height: 75%; font-size: 10px;">
            <?php while($rowLog = $listar->fetch(PDO::FETCH_ASSOC)){ $id = $rowLog['ID_FUNCIONARIO']; $_SESSION['id_edit'] = $id;?>
            <tr>
              ...
              <td style="width: 15%">
                <a class="btn btn-sm btn-info" href="12EditaRegistroFuncionario.php?id=<?php echo $id ?>">
                  <svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-pencil-fill' viewBox='0 0 16 16'>
                    <path d='M12.854.146a.5.5 0 0 0-.707 0L10.5 1.793 14.207 5.5l1.647-1.646a.5.5 0 0 0 0-.708zm.646 6.061L9.793 2.5 3.293 9H3.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.5h.5a.5.5 0 0 1 .5.5v.207zm-7.468 7.468A.5.5 0 0 1 6 13.5V13h-.5a.5.5 0 0 1-.5-.5V12h-.5a.5.5 0 0 1-.5-.5V11h-.5a.5.5 0 0 1-.5-.5V10h-.5a.5.5 0 0 1-.175-.032l-.179.178a.5.5 0 0 0-.11.168l-2 5a.5.5 0 0 0 .65.65l5-2a.5.5 0 0 0 .168-.11z'/>
                  </svg></a>
                <a class="btn btn-sm btn-danger" href="19DeletaFunc.php?id=<?php echo $id ?>">
