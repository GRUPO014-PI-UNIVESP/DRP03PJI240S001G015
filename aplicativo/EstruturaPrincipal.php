<?php
  ...
  if($_SESSION['departamento'] === 'ADMINISTRATIVO' || $_SESSION['credencial'] >= 4){
     $acesso1  = 'aplicativo/00SeletorAdministrativo.php'   ;     $_SESSION['ordena'] = 'NOME_FUNCIONARIO';
     $acesso5  = 'aplicativo/06QuadroFuncionarios.php'      ;     $acesso7  = 'aplicativo/07CadastroFuncionario.php' ;
     $acesso8  = 'aplicativo/08EditaRegistroFuncionario.php';     $acesso9  = 'aplicativo/10DeletaFunc.php'          ;
     $acesso10 = 'aplicativo/11CadastroFuncionario.php'     ;     $acesso11 = 'aplicativo/30EntradaPedido.php'           ;
  ...
  if($_SESSION['departamento'] === 'GARANTIA DA QUALIDADE'|| $_SESSION['credencial'] >= 4){
    $acesso2  = 'aplicativo/01SeletorGQualidade.php';
    $acesso12 = 'aplicativo/40RegistroAnalise.php'  ;  
  }else{ $acesso2 = ''; $acesso12 = ''; }

  if($_SESSION['departamento'] === 'LOGÍSTICA'      || $_SESSION['credencial'] >= 4){
    $acesso3 = 'aplicativo/02SeletorLogistica.php';     
  }else{ $acesso3 = ''; }

  if($_SESSION['departamento'] === 'PRODUÇÃO'       || $_SESSION['credencial'] >= 4){
    $acesso4 = 'aplicativo/03SeletorProducao.php';      
  }else{ $acesso4 = ''; }
  if($_SESSION['credencial'] >= 2){ $acesso6 = 'aplicativo/05MonitorLogin.php'; } else{ $acesso6 = ''; }
...
.sidebarTop {
  ...
  top: 0;
  left: 0;
  background-color: rgba(8, 165, 142, 0.573);
  overflow-x: hidden;
  padding-top: 10px;
  color: whitesmoke;
}
...
.main {
  ...
  padding: 0px 10px; /*define espaçamento superior e à direita do elemento */
}

/* Add media queries for small screens (when the height of the screen is less than 450px, add a smaller padding and font-size) */
@media screen and (max-height: 450px) {
  .sidebarTop {padding-top: 15px;}
  .sidebarTop a {font-size: 18px;}
}
.tab0{
  width: 99%;
  height: 10px;
  ...
  <body>
    ...
    <div class="sidebarBottom"><br>
      ...
      <p style="padding: 3px; color: rgba(0,0,0,0.7)">
        ...
        <a href="aplicativo/15Mensagens.php">
