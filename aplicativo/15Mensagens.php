...
<div class="main">
  <div class="container">
    ...
    <div class="row">
      <div class="col">
        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" style="width: 250px" onclick="location.href='aplicativo/17NovaMsg.php'">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
            <path d="m13.498.795.149-.149a1.207 1.207 0 1 1 1.707 1.708l-.149.148a1.5 1.5 0 0 1-.059 2.059L4.854 14.854a.5.5 0 0 1-.233.131l-4 1a.5.5 0 0 1-.606-.606l1-4a.5.5 0 0 1 .131-.232l9.642-9.642a.5.5 0 0 0-.642.056L6.854 4.854a.5.5 0 1 1-.708-.708L9.44.854A1.5 1.5 0 0 1 11.5.796a1.5 1.5 0 0 1 1.998-.001"/>
          </svg> Enviar Nova Mensagem</button><br><br>
      </div>
      <div class="col">
        <button type="button" class="btn btn-info" data-bs-dismiss="modal" style="width: 350px" onclick="location.href='aplicativo/19MeuHistoricoMsg.php'">
          ...
          <tbody style="height: 20%; font-size: 11px;">
            ...
            <tr>
              ...
              <td style="width: 15%">
                <div class="row">
                  <div class="col">                
                    <a class="btn btn-sm btn-info" href="aplicativo/16VisualizarMsg.php?id=<?php echo $ler ?>">
                      <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-book-half" viewBox="0 0 16 16">
                        <path d="M8.5 2.687c.654-.689 1.782-.886 3.112-.752 1.234.124 2.503.523 3.388.893v9.923c-.918-.35-2.107-.692-3.287-.81-1.094-.111-2.278-.039-3.213.492zM8 1.783C7.015.936 5.587.81 4.287.94c-1.514.153-3.042.672-3.994 1.105A.5.5 0 0 0 0 2.5v11a.5.5 0 0 0 .707.455c.882-.4 2.303-.881 3.68-1.02 1.409-.142 2.59.087 3.223.877a.5.5 0 0 0 .78 0c.633-.79 1.814-1.019 3.222-.877 1.378.139 2.8.62 3.681 1.02A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.293-.455c-.952-.433-2.48-.952-3.994-1.105C10.413.809 8.985.936 8 1.783"/>
                      </svg></a>
                  </div>
                  <div class="col">                
                    <a class="btn btn-sm btn-danger" href="aplicativo/18DeletaMsg.php?id=<?php echo $ler ?>">
