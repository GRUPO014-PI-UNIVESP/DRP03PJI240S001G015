...
if(!empty($dados['submit'])){
  ...
  $cargo    = $dados['cargo']; $departamento = $dados['departamento']; $nomeFunc = strtoupper($dados['nomeFunc']); $responsavel = $_SESSION['nome_func']; 
    ...
    <div class="container">
      ...
      <form class="row g-2" method="POST" action="#">
        ...
        <div class="col-8">
          ...
          <input style="font-size: 12px; text-transform:lowercase" type="email" class="form-control" id="emailFunc" name="emailFunc" value="<?php echo $rowID['EMAIL'];?>">
        </div>
        ...
        <div class="col-md-4">
          ...
          <input style="font-size: 12px" type="text" class="form-control" id="departamento" name="departamento" value="<?php echo $rowID['DEPARTAMENTO'];?>">
        </div>

        <div class="col-md-4">
          <label for="cargo" class="form-label" style="font-size: 10px; color:aqua">Cargo Ocupado</label>
          <input style="font-size: 12px" type="text" class="form-control" id="cargo" name="cargo" value="<?php echo $rowID['CARGO'];?>">
        </div>
        ...
        <div class="col-md-4"><br>
          <!-- Aciona Modal -->
          <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" style="width: 300px">Confirmar Edição</button>
          <!-- Modal -->
