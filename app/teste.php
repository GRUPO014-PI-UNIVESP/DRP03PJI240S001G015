                    ...
                    <div class="row g-1">
                      ...
                      <div class="col-md-4">
                        <div class="input-group mb-3"><span class="input-group-text" id="basic-addon1" style="font-size: 11px; background: rgba(0,0,0,0.3); color: aqua">Qtde</span>
                          <input type="text" class="form-control" aria-label="" aria-describedby="basic-addon1" style="font-weight:bold; font-size: 13px; text-align: center; background: none;" value="<?php echo number_format($rowPedido['QTDE_PEDIDO'], 0, ',', '.') . ' ' . $rowPedido['UNIDADE']; ?>" readonly>
                        </div>
                      </div>
                      <div class="col-md-8">
