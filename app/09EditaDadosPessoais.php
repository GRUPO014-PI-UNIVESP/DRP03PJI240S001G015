...
$_SESSION['posicao'] = 'Atualiza Dados Pessoais';
  ...
  <div class="container">
    ...
    <form class="row g-2" method="POST" action="#">
      ...
      <div class="col-md-2">
        ...
        <input style="text-align: center; font-size: 12px; background: rgba(0,0,0,0.3)" type="number" class="form-control" id="idFunc" name="idFunc" value="<?php echo $dados['ID_FUNCIONARIO']; ?>" readonly>
      </div>

      <div class="col-md-2">
        <label for="dataNasc" class="form-label" style="font-size: 10px; color:aqua">Data de Nascimento</label>
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="date" class="form-control" id="dataNasc" name="dataNasc" value="<?php echo $dados['DATA_NASCIMENTO']; ?>" autofocus>
      </div>

      <div class="col-md-3">
        <label for="cpfFunc" class="form-label" style="font-size: 10px; color:aqua">C.P.F.</label>
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="CPFInput" name="cpfFunc" value="<?php echo $dados['CPF']; ?>" maxlength="11" onkeyup="criaMascara('CPF')">
      ...
      <div class="col-md-3">
        ...
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="RGInput" name="rgFunc" value="<?php echo $dados['RG']; ?>" maxlength="9" onkeyup="criaMascara('RG')">
        <p style="font-size: 10px; color: grey">Somente números</p>
      </div>

      <div class="col-12">
        <label for="nomeFunc" class="form-label" style="font-size: 10px; color:aqua">Nome Completo</label>
        <input style="font-size: 12px; text-transform:uppercase; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="nomeFunc" name="nomeFunc" value="<?php echo $dados['NOME_FUNCIONARIO']; ?>" maxlength="120">
      ...
      <div class="col-8">
        ...
        <input style="font-size: 12px; text-transform:lowercase; background: rgba(0,0,0,0.3)" type="email" class="form-control" id="emailFunc" name="emailFunc" value="<?php echo $dados['EMAIL']; ?>">
        <p style="font-size: 10px; color: grey">Tamanho máximo de 120 caracteres</p>
      </div>

      <div class="col-md-4">
        <label for="telefone" class="form-label" style="font-size: 10px; color:aqua">Telefone de Contato</label>
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="CelularInput" name="telefone" value="<?php echo $dados['TELEFONE']; ?>" maxlength="11" onkeyup="criaMascara('Celular')">
      ...
      <div class="col-10">
        ...
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="ruaRes" name="ruaRes" value="<?php echo $dados['RUA_RES']; ?>">
      </div>

      <div class="col-md-2">
        <label for="numRes" class="form-label" style="font-size: 10px; color:aqua">Número da Residência</label>
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="numRes" name="numRes" value="<?php echo $dados['NUM_RES']; ?>" maxlength="6">
        <p style="font-size: 10px; color: grey">Somente números</p>
      </div>

      <div class="col-md-3">
        <label for="cplRes" class="form-label" style="font-size: 10px; color:aqua">Complemento</label>
        <input style="font-size: 12px; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="cplRes" name="cplRes" value="<?php echo $dados['COMPLEMENTO']; ?>">
      ...
      <div class="col-md-3">
        ...
        <input style="font-size: 12px; text-transform:uppercase; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="bairro" name="bairro" value="<?php echo $dados['BAIRRO']; ?>">
      </div>

      <div class="col-md-4">
        <label for="cidade" class="form-label" style="font-size: 10px; color:aqua">Cidade</label>
        <input style="font-size: 12px; text-transform:uppercase; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="cidade" name="cidade" value="<?php echo $dados['CIDADE']; ?>">
      </div>

      <div class="col-md-2">
        <label for="uf" class="form-label" style="font-size: 10px; color:aqua">Estado (U.F.)</label>
        <input style="font-size: 12px; text-transform:uppercase; background: rgba(0,0,0,0.3)" type="text" class="form-control" id="uf" name="uf" value="<?php echo $dados['UF']; ?>" maxlength="2">
      </div>

      <!-- Botão para acessar -->
      <div class="col-md-4"><br>
        <input class="btn btn-primary" type="submit" id="submit" name="submit" value="Confirmar e Salvar" style="width: 280px; float: right">
      </div><br>
