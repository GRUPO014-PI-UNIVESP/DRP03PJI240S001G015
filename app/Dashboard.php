<?php
  ...
  include_once './EstruturaPrincipal.php'; $_SESSION['posicao'] = 'Dashboard'; include_once './RastreadorAtividades.php';

  $CurrentHour = date('H');
  if ($CurrentHour >= 6 && $CurrentHour < 12) { $Greeting = 'Tenha um Bom Dia.';}
  elseif ($CurrentHour >= 12 && $CurrentHour < 18) { $Greeting = 'Tenha uma Boa Tarde.';}
  else { $Greeting = 'Tenha uma Boa Noite.';}
?>
<script>
