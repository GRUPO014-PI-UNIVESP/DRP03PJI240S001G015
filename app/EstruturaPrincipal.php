<?php
  ...
  // atualização das tabelas de estoque de materiais e pedidos
...
while($verifica = $pedido->fetch(PDO::FETCH_ASSOC)){
   ...
   if($conta == $itens){
      $atualiza = 'MATERIAIS LIBERADOS, AGUARDANDO FABRICAÇÃO'; $etapa = 1;
      if($verifica['ETAPA_PROD'] == 0){
