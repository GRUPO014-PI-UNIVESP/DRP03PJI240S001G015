  ...
  <div class="container">
    ...
    <form class="row g-2" method="POST" action="#">
      ...
      <div class="col-md-3">
        ...
        <input style="font-size: 12px" type="text" class="form-control" id="CPFInput" name="cpfFunc" value="<?php echo $dados['CPF']; ?>" maxlength="11" oninput="criaMascara('CPF')">
      </div>

      <div class="col-md-3">
        <label for="rgFunc" class="form-label" style="font-size: 10px; color:aqua">R.G.</label>
        <input style="font-size: 12px" type="text" class="form-control" id="RGInput" name="rgFunc" value="<?php echo $dados['RG']; ?>" maxlength="9" oninput="criaMascara('RG')">
      </div>
      ...
      <div class="col-md-4">
        ...
        <input style="font-size: 12px" type="text" class="form-control" id="CelularInput" name="telefone" value="<?php echo $dados['TELEFONE']; ?>" maxlength="11" oninput="criaMascara('Celular')">
      </div>
